#ifndef __CODE_TABLES_H
#define __CODE_TABLES_H
...
static struct code_table_item CoeffTokenCodes[4][64] = { 
{
///// 0  <=  nC  <  2 /////
  { 0x00000000,  0, 0 },  // BOT
...
static struct code_table_item CoeffTokenCodes_ChromaDC[15]={
...
static struct code_table_item TotalZerosCodes_4x4[15][18]={ {
///// 1 /////
  { 0x00000000,  0, 0 },  // BOT
...
static struct code_table_item TotalZerosCodes_ChromaDC[3][5]={ {
///// 1 /////
  { 0x00000000,  3, 3 },  // 000
  { 0x20000000,  3, 2 },  // 001
  { 0x40000000,  2, 1 },  // 01
...
static struct code_table_item RunBeforeCodes[6][17]={ {
///// 1 /////
  { 0x00000000,  1, 1 },  // 0
  { 0x80000000,  1, 0 },  // 1
  { 0xFFFFFFFF,  0, 0 }  // EOT
